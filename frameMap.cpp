...
void Tframe1Map::fillFieldsVectorWithFields()
{
	...
	this->fieldsVector.push_back(new Port(1, this->field01, this->field01PortGlyph, new TportsCardFrame(this, 1), 100, 25, "Haga", NETHERLANDS));
	this->fieldsVector.push_back(new Field(2, this->field02));
	this->fieldsVector.push_back(new Port(3, this->field03, this->field03PortGlyph, new TportsCardFrame(this, 3), 100, 25, "Domburg", NETHERLANDS));
	this->fieldsVector.push_back(new Port(4, this->field04, this->field04PortGlyph, new TportsCardFrame(this, 4), 100, 25, "Den Helder", NETHERLANDS));
	this->fieldsVector.push_back(new Field(5, this->field05));
	this->fieldsVector.push_back(new Port(6, this->field06, this->field06PortGlyph, new TportsCardFrame(this, 6), 100, 25, "Maasvlakte Rotterdam", NETHERLANDS));
	...
	this->fieldsVector.push_back(new Port(10, this->field10, this->field10PortGlyph, new TportsCardFrame(this, 10), 100, 25, "Barcelona", SPAIN));
	this->fieldsVector.push_back(new Field(11, this->field11));
	this->fieldsVector.push_back(new Port(12, this->field12, this->field12PortGlyph, new TportsCardFrame(this, 11), 100, 25, "Valencia", SPAIN));
	this->fieldsVector.push_back(new Field(13, this->field13));
	this->fieldsVector.push_back(new Port(14, this->field14, this->field14PortGlyph, new TportsCardFrame(this, 14), 100, 25, "Bilbao", SPAIN));
	this->fieldsVector.push_back(new Port(15, this->field15, this->field15PortGlyph, new TportsCardFrame(this, 15), 100, 25, "Las Palmas", SPAIN));
	...
	this->fieldsVector.push_back(new Port(19, this->field19, this->field19PortGlyph, new TportsCardFrame(this, 19), 100, 25, "Brington", GREAT_BRITAIN));
	this->fieldsVector.push_back(new Port(20, this->field20, this->field20PortGlyph, new TportsCardFrame(this, 20), 100, 25, "London", GREAT_BRITAIN));
	this->fieldsVector.push_back(/*new Field(21, this->field21)*/new PirateShip(21, this->field21, new TpirateShipCardFrame(this, 2)));
	this->fieldsVector.push_back(new Port(22, this->field22, this->field22PortGlyph, new TportsCardFrame(this, 22), 100, 25, "Southampton", GREAT_BRITAIN));
	this->fieldsVector.push_back(new Port(23, this->field23, this->field23PortGlyph, new TportsCardFrame(this, 23), 100, 25, "Belfast", GREAT_BRITAIN));
	this->fieldsVector.push_back(new Field(24, this->field24));
	this->fieldsVector.push_back(new Port(25, this->field25, this->field25PortGlyph, new TportsCardFrame(this, 25), 100, 25, "Bordeaux", FRANCE));
	this->fieldsVector.push_back(new Port(26, this->field26, this->field26PortGlyph, new TportsCardFrame(this, 26), 100, 25, "Calais", FRANCE));
	this->fieldsVector.push_back(new Whirlpool(27, this->field27, new TwhirlpoolCardFrame(this)));
	this->fieldsVector.push_back(new Port(28, this->field28, this->field28PortGlyph, new TportsCardFrame(this, 28), 100, 25, "Marsylia", FRANCE));
	this->fieldsVector.push_back(new Port(29, this->field29, this->field29PortGlyph, new TportsCardFrame(this, 29), 100, 25, "Montpellier", FRANCE));
	this->fieldsVector.push_back(new Field(30, this->field30));
	this->fieldsVector.push_back(new Port(31, this->field31, this->field31PortGlyph, new TportsCardFrame(this, 31), 100, 25, "Lizbona", PORTUGAL));
	this->fieldsVector.push_back(new Storm(32, this->field32, NULL));
	this->fieldsVector.push_back(new Port(33, this->field33, this->field33PortGlyph, new TportsCardFrame(this, 33), 100, 25, "Setubal", PORTUGAL));
	this->fieldsVector.push_back(new Port(34, this->field34, this->field34PortGlyph, new TportsCardFrame(this, 34), 100, 25, "Madera", PORTUGAL));
	this->fieldsVector.push_back(new Port(35, this->field35, this->field35PortGlyph, new TportsCardFrame(this, 35), 100, 25, "Vania do Castelo", PORTUGAL));
}
